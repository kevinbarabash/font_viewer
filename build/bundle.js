...
/***/ function(module, exports, __webpack_require__) {
	...
	var GlyphView = __webpack_require__(3);
	...
	var block_ranges = {
	    ...
	    'latin-1': [128, 255],
	    'greek': [880, 1023],
	    'math-operators': [8704, 8959]
	};

	var FontViewer = (function (_React$Component) {
	    function FontViewer() {
	        var _this = this;

	        _classCallCheck(this, FontViewer);
	        ...
	        this.clickHandler = function (id) {
	            _this.setState({ selectedGlyph: id });
	        };

	        this.onChange = function (e) {
	            var block = e.target.selectedOptions[0].value;
	            (function callee$3$0() {
	                var metrics, outlines, _block_ranges$block, begin, end;

	                return regeneratorRuntime.async(function callee$3$0$(context$4$0) {
	                    while (1) switch (context$4$0.prev = context$4$0.next) {
	                        case 0:
	                            context$4$0.next = 2;
	                            return get('../metrics/' + block + '.json');

	                        case 2:
	                            metrics = context$4$0.sent;
	                            context$4$0.next = 5;
	                            return get('../outlines/' + block + '.json');

	                        case 5:
	                            outlines = context$4$0.sent;
	                            _block_ranges$block = _slicedToArray(block_ranges[block], 2);
	                            begin = _block_ranges$block[0];
	                            end = _block_ranges$block[1];

	                            this.setState({ metrics: metrics, outlines: outlines, begin: begin, end: end });
	    ...
	    _inherits(FontViewer, _React$Component);

	    _createClass(FontViewer, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            (function callee$2$0() {
	                var metrics, outlines, _block_ranges$block2, begin, end;
	                ...
	                return regeneratorRuntime.async(function callee$2$0$(context$3$0) {
	                    while (1) switch (context$3$0.prev = context$3$0.next) {
	                        ...
	                        case 2:
	                            metrics = context$3$0.sent;
	                            context$3$0.next = 5;
	                            return get('../outlines/' + block + '.json');

	                        case 5:
	                            outlines = context$3$0.sent;
	                            _block_ranges$block2 = _slicedToArray(block_ranges[block], 2);
	                            begin = _block_ranges$block2[0];
	                            end = _block_ranges$block2[1];
	            ...
	            if (this.state.metrics) {
	                ...
	                for (var i = begin; i <= end; i++) {
	                    ...
	                    tiles.push(React.createElement(
	                        Tile,
	                        { key: i, id: i, size: 50, color: color, onClick: this.clickHandler },
	...
	var fontViewer = React.createElement(FontViewer, null);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GlyphView = (function (_React$Component) {
	    function GlyphView() {
	        _classCallCheck(this, GlyphView);
	    ...
	    _inherits(GlyphView, _React$Component);

	    _createClass(GlyphView, [{
	        key: 'drawGlyph',
	        value: function drawGlyph(props) {
	            ...
	            ctx.beginPath();
	            this.props.outlines[code].forEach(function (outline) {
	        ...
	        value: function render() {
	            ...
	            return React.createElement('canvas', { width: size, height: size });
	        }
	    }], [{
	        key: 'propTypes',
	        value: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = (function (_React$Component) {
	    ...
	    _createClass(Tile, [{
	        ...
	        value: function render() {
	            var size = this.props.size;
	            return React.createElement('canvas', { width: size, height: size, onClick: this.handleClick });
	        }
	    }], [{
	        key: 'propTypes',
	        value: {
